                ...
                switch (line) {
                    ...
                    default:
                        ...
                        for (code_line in code_split) {
                            ...
                            document.write('<div id="code_content'+ code_line +'" style=";padding-left: 10px;padding-bottom: 5px; padding-top: 5px; background-color: rgb(22, 27, 34);color: #DEEFE7;"> ' + line_display + '</div>');
                        }
                        break;
                    }
            }
