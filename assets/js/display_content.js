...
var raw_content = 'lucabln ^%^ PYTHON 3.10 ^%^ print("Hello World!") ^%^ for i in range(10): ^%^ print(i) ^$^github_user ^%^ JavaScript ^%^ console.log("Hello Wold") ^%^ for (i in range(10)): ^%^ console.log(i)';
